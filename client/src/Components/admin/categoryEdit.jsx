...
export default function EditCategory({ category, baseUrl }) {
  ...
  const Submit_Handler = (event) => {
    ...
    axiosApiInstrector
      .put("category/update/"+category._id, formData)
      .then((response) => {
      ...
      ">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-gray-600 mt-3 text-lg tracking-wide">
            Update your category details with a premium modern interface.
          </p>
        </div>
